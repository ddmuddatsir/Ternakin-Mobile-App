...
const ProductSubcribe = ({ productCourse }) => {
  const navigation = useNavigation();

  const levelIcon = getLevelIcon(productCourse.level);
  const priceColor = getPriceColor(productCourse.price);
  const priceDisplay = getPriceDisplay(productCourse.price);
...
const ProductSubcribeLarge = ({ productCourse }) => {
  const navigation = useNavigation();
        ...
        <View>
          ...
          >
            ...
            >
              ...
              />
              <Text
                style={{ fontSize: 14, color: GlobalStyles.colors.text100 }}
              >
                {productCourse.level}
              </Text>
              <View
              ...
              >
                <FontAwesome5
                  ...
                  color={GlobalStyles.colors.text100}
                />
                <Text>To raise {productCourse.category}</Text>
              </View>
            </View>
            <View
              style={{
...
const ProductSubcribeRecommendation = ({ productCourse }) => {
  const navigation = useNavigation();
  const priceDisplay = getPriceDisplay(productCourse.price);
...
export { ProductSubcribe, ProductSubcribeLarge, ProductSubcribeRecommendation };
