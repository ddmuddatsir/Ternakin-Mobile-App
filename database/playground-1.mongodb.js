...
db.getCollection("product").insertMany([
  ...
  },
  {
    ...
    stock: 30,
    condition: "Breeding-ready",
    minOrder: 1,
    shedPen: "Bull",
    advantages: [
      "Top Breeder: Exceptional genetics for breeding strong and healthy calves.",
      "Vigor and Strength: Tested for physical stamina and reproductive health.",
      "Proven Success: Comes from a long line of high-quality breeders.",
      "Disease-Resistant: Ensured to be free from major health risks.",
      "High Fertility Rate: Known for high conception rates.",
    ],
    shippingMethod: {
      location: "Bandung",
      estimate: [
    ...
    farm: {
      ...
      image: "https://example.com/prime-bull.jpg",
    },
    buyerReviews: [
      {
        name: "AgriFarm Corp.",
        rating: 5,
        reviewText:
          "Outstanding breeding bull. Already seeing results in our herd.",
        reviewDate: "2024-08-23",
        image: "https://example.com/bull-review.jpg",
        photoReview: [
          "https://images.unsplash.com/photo-1560807707-8cc77767d783?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8YnVsbHxlbnwwfHwwfHx8MA%3D%3D",
          "https://images.unsplash.com/photo-1518918305363-bfdf2b7e35a7?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8YnVsbHxlbnwwfHwwfHx8MA%3D%3D",
        ],
      },
    ],
  },
